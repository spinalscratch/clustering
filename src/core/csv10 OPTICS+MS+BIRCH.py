...
from bin.params_algo_csv10 import optics_params, meanshift_params, birch_params

def main():
    output_dir = "../../results/csv10"
    os.makedirs(output_dir, exist_ok=True)
    today_str = datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
    output_path = os.path.join(output_dir, f"risultati_cluster_csv10_{today_str}.txt")
